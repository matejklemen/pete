...
general_parser.add_argument("--test_path", type=str,
                            default="/home/matej/Documents/data/SST-2/dev_xs.tsv")
...
general_parser.add_argument("--model_dir", type=str,
                            default="/home/matej/Documents/embeddia/interpretability/explain_nlp/resources/weights/classifiers/bert-base-uncased-sst2-maxseqlen44-2e-5")
general_parser.add_argument("--model_max_seq_len", type=int, default=44)
...
general_parser.add_argument("--generator_dir", type=str,
                            ...
                            default="/home/matej/Documents/embeddia/interpretability/explain_nlp/resources/weights/language_models/bert-base-uncased-sst2-mlm")
general_parser.add_argument("--generator_batch_size", type=int, default=8)
general_parser.add_argument("--generator_max_seq_len", type=int, default=44)
...
ime_parser.add_argument("--train_path", type=str, default="/home/matej/Documents/data/SST-2/train.tsv")
...
if __name__ == "__main__":
    ...
    dataset_name = "sst-2"  # some arguments can be automatically extracted from presets
    ...
    raw_examples = df_test["sentence"].tolist()
    ...
    generator = load_generator(args, clm_labels=["<NEGATIVE>", "<POSITIVE>"])
    ...
    if args.use_contrastive_control:
        ...
        contrastive_labels = {
            LABEL_TO_IDX["sst-2"][0]: LABEL_TO_IDX["sst-2"][1],
            LABEL_TO_IDX["sst-2"][1]: LABEL_TO_IDX["sst-2"][0]
        }
    ...
    for idx_example in range(start_from, until):
        ...
        actual_label = int(LABEL_TO_IDX[dataset_name][df_test.iloc[idx_example]["label"]])
