...
from experiments.sentinews_sentiment.data import load_sentinews, SequenceDataset, LABEL_TO_IDX, IDX_TO_LABEL
from experiments.sentinews_sentiment.handle_generator import load_generator
...
parser.add_argument("--test_path", type=str, default="/home/matej/Documents/data/SentiNews/split/test_xs.txt")

parser.add_argument("--model_dir", type=str, default="/home/matej/Documents/embeddia/interpretability/ime-lm/examples/weights/crosloengual_sentinews_maxseqlen68")
parser.add_argument("--model_max_seq_len", type=int, default=68)
parser.add_argument("--model_max_words", type=int, default=47)
...
if __name__ == "__main__":
    ...
    test_set = SequenceDataset(content=df_test["content"].values,
                               labels=df_test["sentiment"].apply(lambda lbl: LABEL_TO_IDX[lbl]).values,
    ...
    if args.method in {"ime", "sequential_ime", "whole_word_ime"}:
        ...
        train_set = SequenceDataset(content=df_train["content"].values,
                                    labels=df_train["sentiment"].apply(lambda lbl: LABEL_TO_IDX[lbl]).values,
