...
if __name__ == "__main__":
    ...
    for idx_example, curr_example in enumerate(df_test.iloc[start_from: until]["content"].values,
                                               start=start_from):
        if args.method == "whole_word_ime" or args.custom_features is not None:
        ...
        actual_label = int(df_test.iloc[[idx_example]]["sentiment"].apply(lambda lbl: LABEL_TO_IDX["sentinews"][lbl]))
