...
general_parser.add_argument("--test_path", type=str,
                            default="/home/matej/Documents/data/imsypp/split/test.csv")
...
general_parser.add_argument("--model_dir", type=str,
                            default="/home/matej/Documents/embeddia/interpretability/explain_nlp/resources/weights/classifiers/crosloengual-bert-imsypp")
...
general_parser.add_argument("--generator_dir", type=str,
                            ...
                            default="/home/matej/Documents/embeddia/interpretability/explain_nlp/resources/weights/language_models/crosloengual-bert-imsypp-mlm")
...
ime_parser.add_argument("--train_path", type=str, default="/home/matej/Documents/data/imsypp/split/train.csv")
...
if __name__ == "__main__":
    ...
    dataset_name = "imsypp"  # some arguments can be automatically extracted from presets
    ...
    raw_examples = df_test["besedilo"].tolist()
    ...
    generator = load_generator(args, clm_labels=["<CLEAN>", "<HATE>"])
    ...
    for idx_example in range(start_from, until):
        ...
        actual_label = int(LABEL_TO_IDX[dataset_name][df_test.iloc[idx_example]["vrsta"]])
