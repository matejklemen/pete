...
from explain_nlp.methods.generation import GPTLMGenerator
...
parser.add_argument("--generator_dir", type=str, default="/home/matej/Documents/embeddia/interpretability/ime-lm/examples/weights/gpt_snli_lm_maxseqlen42",
...
parser.add_argument("--masked_at_once", type=float, default=None,
                    help="Proportion of tokens to mask out at once during language modeling. By default, "
