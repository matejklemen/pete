...
"""Compute importances that satisfy theoretical 'guarantees' on max AE specified by `confidence_interval` and 
`max_abs_error` with IME. Ran on SNLI. See config.json for specific options."""
...
if __name__ == "__main__":
    ...
    if experiment_dir is None:
        experiment_dir = f"snli_strict_importances_ci{args.confidence_interval}_maxabserr" \
