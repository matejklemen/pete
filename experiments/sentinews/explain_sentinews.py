...
if __name__ == "__main__":
    ...
    if args.use_contrastive_control:
        ...
        contrastive_labels = {
            LABEL_TO_IDX["sentinews"]["neutral"]: LABEL_TO_IDX["sentinews"]["negative"],
            LABEL_TO_IDX["sentinews"]["negative"]: LABEL_TO_IDX["sentinews"]["positive"],
            LABEL_TO_IDX["sentinews"]["positive"]: LABEL_TO_IDX["sentinews"]["negative"],
        }
