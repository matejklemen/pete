...
if __name__ == "__main__":
    ...
    if args.use_contrastive_control:
        ...
        contrastive_labels = {
            LABEL_TO_IDX["snli"]["entailment"]: LABEL_TO_IDX["snli"]["contradiction"],
            LABEL_TO_IDX["snli"]["neutral"]: LABEL_TO_IDX["snli"]["contradiction"],
            LABEL_TO_IDX["snli"]["contradiction"]: LABEL_TO_IDX["snli"]["entailment"],
        }
